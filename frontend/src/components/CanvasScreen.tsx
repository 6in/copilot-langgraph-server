...
// Canvas App hub screen: lists deployed apps and provides CTA to start a new chat.
// Phase 16: D-08 (hub screen), D-09 (new chat CTA), D-10 (existing app → chat), D-11 (back to menu).
